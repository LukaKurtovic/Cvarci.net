...
<!---------------------------------------------------SIDE-NAV ---------------------- -->
    ...
    <section class="create-container">
        ...
        <form action="" method="POST">
            ...
            <input class="input-form" type="text" id="product-name" name="product-name" value="<?= $row['ime'] ?>" required>
            <label class="form-text" for="url">Url slike :</label>
            <input class="input-form" type="text" id="url" name="url" value="<?= $row['slika'] ?>" required>
            <label class="form-text" for="price">Cijena :</label>
            <input class="input-form" type="number" id="price" name="price" value="<?= $row['cijena'] ?>"required>
            <label class="form-text" for="amount">Količina :</label>
            <input class="input-form" type="number" id="amount" name="amount" value="<?= $row['kolicina'] ?>" required>
            <button type="submit" class="submit-product">Uredi proizvod</button>
