...
<!--------------- HEADER -------------------------------------------------------------------->
    <section class="header">
        <nav>
            ...
            <ul aria-label="prijava i košarica s narudžbom">
                <li>
                   <a  class="button-nav-style"id="prijava-button" type="button" href="admin.php">
                       <i class="far fa-user "></i><span>PRIJAVI SE</span>
                   </a> 
                </li>
